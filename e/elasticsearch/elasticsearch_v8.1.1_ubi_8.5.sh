...
WORKDIR=`pwd`
ELASTICSEARCH_VERSION=${1:-v8.1.1}
...
# Apply patches
wget https://github.com/muskaan2199/build-scripts/raw/Currency/e/elasticsearch/elasticsearch_8.1.1.patch
git apply elasticsearch_8.1.1.patch
